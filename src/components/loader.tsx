export default function PageLoader() {
  return (
    <div class="absolute left-0 top-0 z-[888] m-0 h-screen w-full bg-gray-100/80 dark:bg-black/80 p-0">
      <div class="absolute w-full h-7 bg-transparent z-[999]" data-tauri-drag-region />
